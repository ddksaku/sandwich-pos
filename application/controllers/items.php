...
class Items extends Secure_area implements iData_controller
{
	...
	*/
    ...
    function item_categories_search1()
    {
    	$category_id = $this->input->post('category_id');
    	$suggestions = $this->Item->get_item_kit_search_suggestion1($this->input->post('q'),$this->input->post('limit') , $category_id);
    	//echo implode("\n",$suggestions);
    	echo $suggestions;
    }


    function item_categories_search()
    {
        $category_id = $this->input->post('category_id');
        $suggestions = $this->Item->get_item_kit_search_suggestion($this->input->post('q'),$this->input->post('limit') , $category_id);
        //echo implode("\n",$suggestions);
        echo $suggestions;
    }
	...
	*/
	...
	function view($item_id=-1)
	{
        ...
        $data['categories']=$this->Item->get_sub_categories();
...
*/
	...
	{
		$replace_id = $this->input->post('replace_id');
		if(isset($replace_id)) $item_id = $replace_id;
		$item_data = array(
